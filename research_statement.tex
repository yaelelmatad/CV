...
To investigate behaviors of rare events , we have used advanced sampling methods developed to study ensembles of trajectories. One of the most significant of these was transition path sampling (TPS) %\cite{Bolhuis_AnnuRevPhysChem_2002}.  
